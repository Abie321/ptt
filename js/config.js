...
LEVEL_5_CONFIG['TIER_ENTITIES'] = {
        ...
        2 : [
            ...
            },
            {
                ...
                hideInPreviousTier: true,
                positions: [
                    { x: 152, y: 680, rotation: 270 },
                    { x: 334, y: 680, rotation: 270 },
                    { x: 472, y: 680, rotation: 270 },
                    { x: 563, y: 680, rotation: 270 },
                    { x: 654, y: 680, rotation: 270 },
                    { x: 1112, y: 680, rotation: 270 },
                    { x: 1203, y: 680, rotation: 270 },
                    { x: 1294, y: 680, rotation: 270 },
                    { x: 106, y: 1360, rotation: 90 },
                    { x: 197, y: 1360, rotation: 90 },
                    { x: 472, y: 1360, rotation: 90 },
                    { x: 563, y: 1360, rotation: 90 },
                    { x: 928, y: 1360, rotation: 90 },
                    { x: 1020, y: 1360, rotation: 90 },
                    { x: 1112, y: 1360, rotation: 90 },
                    { x: 1248, y: 1360, rotation: 90 },
                    { x: 850, y: 357 },
                    { x: 850, y: 459 },
                    { x: 850, y: 561 },
                    { x: 850, y: 868 },
