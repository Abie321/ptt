...
LEVEL_2_CONFIG.SIZE_TIERS = [
    { tier: 1, threshold: 20, name: 'Nano', color: 0x607D8B, zoom: 1.0, zoomInStart: 1.0, WORLD: { WIDTH: 1600, HEIGHT: 1200 }, ASSETS: { BACKGROUND_IMAGE: 'assets/images/background.png', BACKGROUND_SCALE: 1.0, TILE_BACKGROUND: true } },
    { tier: 2, threshold: 30, name: 'Mini', color: 0x9E9E9E, zoom: 0.9, zoomInStart: 2.0, WORLD: { WIDTH: 1800, HEIGHT: 1400 }, ASSETS: { BACKGROUND_IMAGE: 'assets/images/background.png', BACKGROUND_SCALE: 1.0, TILE_BACKGROUND: true } },
    { tier: 3, threshold: 40, name: 'Small', color: 0x795548, zoom: 0.8, zoomInStart: 2.0, WORLD: { WIDTH: 2000, HEIGHT: 1600 }, ASSETS: { BACKGROUND_IMAGE: 'assets/images/background.png', BACKGROUND_SCALE: 1.0, TILE_BACKGROUND: true } },
    { tier: 4, threshold: 50, name: 'Average', color: 0xFF5722, zoom: 0.7, zoomInStart: 2.0, WORLD: { WIDTH: 2200, HEIGHT: 1800 }, ASSETS: { BACKGROUND_IMAGE: 'assets/images/background.png', BACKGROUND_SCALE: 1.0, TILE_BACKGROUND: true } },
    { tier: 5, threshold: 60, name: 'Massive', color: 0xE91E63, zoom: 0.6, zoomInStart: 2.0, WORLD: { WIDTH: 2400, HEIGHT: 2000 }, ASSETS: { BACKGROUND_IMAGE: 'assets/images/background.png', BACKGROUND_SCALE: 1.0, TILE_BACKGROUND: true } }
];
